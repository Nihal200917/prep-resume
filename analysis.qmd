...
fit_resume |>
  ...
  labs(title = "Posterior for Callback Rates",
       subtitle = "Resumes with white_coded names are much more likely to receive callbacks",
       x = "Probability of Callback",
       y = "",
       color = "(Likely) Race of Name on Resume")
```




What are we predicting ~ What is the thing the could explain or predict the first variable
